...
**RAG Assistant** — ассистент, который отвечает на вопросы по вашим документам.

- **Задача:** сократить время ручного поиска по базе знаний, регламентам и материалам.
- **Решение:** RAG‑пайплайн находит релевантные фрагменты в векторном хранилище и формирует ответ, опираясь на найденный контекст.
- **Пример использования:** сотрудник задаёт вопрос по регламенту → ассистент возвращает ответ с выдержками из документа.
